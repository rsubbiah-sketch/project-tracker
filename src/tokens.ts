...
/** Accent for selected/active button states — uses CSS variable */
export const accent = "var(--accent)";
/** Primary text for selected button labels — uses CSS variable */
export const accentText = "var(--primary)";
...
export const PILLARS = [
  {key:"t",label:"Product",icon:"T",desc:"Engineering soundness",subKey:"ts"},
